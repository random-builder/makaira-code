...
#define MESH_BED_LEVELING    // Enable mesh bed leveling.
  ...
  #define GRID_MAX_POINTS_X_POINTS 3  // Don't use more than 7 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y_POINTS 3
  #define LCD_PROBE_Z_RANGE 4  // Z after Home, bed somewhere below but above 0.0.

  //#define MESH_G28_REST_ORIGIN // After homing all axes ('G28' or 'G28 XYZ') rest at origin [0,0,0]

  #define LCD_BED_LEVELING  // Add display menu option for bed leveling.
